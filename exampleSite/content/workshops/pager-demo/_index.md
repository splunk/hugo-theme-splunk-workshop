...
A small workshop that demonstrates the [`pager` shortcode](/docs/shortcodes/06-utilities/#pager) and the `nopager` front-matter flag. Each page exhibits a different navigation pattern. Click through end-to-end and watch the pager change at the bottom of each page.
...
- **Page 6 — `nopager: true`.** The page itself renders no pager; neighbouring pages skip over it in their own chain.
