...
If you author content for a context where reset is needed, add a small footer button to your own `layouts/_partials/chrome/footer.html` override that calls `localStorage.removeItem("splunk-workshop:visited")` and reloads the page.
