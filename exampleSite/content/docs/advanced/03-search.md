...
- **[Pagefind](https://pagefind.app/)** — drop-in static-site search, runs at build time, very capable. Works alongside this theme — just override `partials/head.html` and `layouts/partials/footer.html` to load Pagefind.
